    ...
    public partial class Form1 : Form
    {
        ...
        private void SetupAndAddToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (d.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    string s = File.ReadAllText("server_template.txt");
                    s = s.Replace("##0##", d2.textBox1.Text);
                    s = s.Replace("##1##", d2.textBox2.Text);
                    s = s.Replace("##2##", d2.textBox3.Text);
                    s = s.Replace("##3##", d2.textBox4.Text);
                    s = s.Replace("##4##", d2.textBox5.Text);
                    s = s.Replace("##5##", d2.textBox6.Text);
                    s = s.Replace("##6##", d2.textBox7.Text);
                    s = s.Replace("##7##", d2.textBox8.Text);
                    s = s.Replace("##8##", d2.textBox9.Text);
                    s = s.Replace("##9##", d2.textBox10.Text);
                    s = s.Replace("##10##", Config.settings["ip"]);
                    s = s.Replace("##11##", Config.settings["port_tcp"]);
                    File.WriteAllText(path + "config.txt", s);
