...
namespace Server
{
    public static class BlueZoneManager
    {
        ...
        //{
        //    new BlueZoneStateStep(BlueZoneState.Waiting,    456.47f,    296.71f,    30,    0.4f,   new float[]{ 2048f, -2048f },   new float[]{ 2048f, -2048f }),
        //    new BlueZoneStateStep(BlueZoneState.Shrinking,  456.47f,    296.71f,    7200,    0.4f,   new float[]{ 2048f, -2048f },   new float[]{ 2048f, -2048f }),
        //
        //    new BlueZoneStateStep(BlueZoneState.Waiting,    296.71f,    148.35f,    200000,    0.6f,   new float[]{ 2048f, -2048f },   new float[]{ 2048f, -2048f }),
        //    new BlueZoneStateStep(BlueZoneState.Shrinking,  296.71f,    148.35f,    340000,    0.6f,   new float[]{ 2048f, -2048f },   new float[]{ 2048f, -2048f }),
        //
        //};
